...
class PhotoFilterSelectors extends StatefulWidget {
  final Widget title;
...
class _PhotoFilterSelectorState extends State<PhotoFilterSelectors> {
  String filename;
          ...
          loading
              ...
              : IconButton(
                  ...
                  onPressed: () async {
                    ...
                    Navigator.pop(context, {'image_filtered':imageFile, 'caption': captionController.text.toString()} );
                  },
                )
        ],
      ),
                ...
                children: [
                  ...
                  Expanded(
                    ...
                    child: Container(
                      width: double.infinity,
                      height: 50,
                      padding: EdgeInsets.only(left: 12.0, right: 12.0, top: 3.0, bottom: 2.0),
